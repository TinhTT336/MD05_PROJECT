...
public class BorrowedCartServiceImpl implements BorrowedCartService {
    ...
    @Override
    public BorrowedCartResponseDTO save(BorrowedCartRequestDTO borrowedCartRequestDTO) throws UserNotFoundException, CustomException, BookException {
        User user = userRepository.findById(borrowedCartRequestDTO.getUserId())
                .orElseThrow(() -> new UserNotFoundException("Don't find user with this id " + borrowedCartRequestDTO.getUserId()));
