...
public class WaitingListController {
    ...
    @PostMapping("")
    public ResponseEntity<?> addWaitingList(HttpServletRequest request, @RequestParam Long bookId) throws UserNotFoundException, BookException, CustomException {
        UserResponseDTO userResponseDTO=userService.getAccount(request);
    ...
    public ResponseEntity<?>deleteWaitingList(HttpServletRequest request,@PathVariable Long waitingId) throws CustomException {
        WaitingListResponseDTO waitingListResponseDTO=waitingListService.findById(waitingId);
