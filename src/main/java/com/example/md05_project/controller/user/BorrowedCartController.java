...
public class BorrowedCartController {
    ...
    @GetMapping("/{cartId}")
    public ResponseEntity<?> getById(@PathVariable("cartId") Long cartId) throws CustomException, UserNotFoundException {
        List<BorrowedCartDetailDTO> list = borrowedCartDetailService.findByCartId(cartId);
    ...
    public ResponseEntity<?> addBorrowedCart(@RequestBody BorrowedCartRequestDTO borrowedCartRequestDTO, HttpServletRequest request)
        ...
        UserResponseDTO userResponseDTO = userService.getAccount(request);
        BorrowedCartResponseDTO borrowedCartResponseDTO = borrowedCartService.save(borrowedCartRequestDTO);
    ...
    public ResponseEntity<?> returnCart(@PathVariable("cartId") Long cartId) throws BookException, CustomException {
        BorrowedCartResponseDTO borrowedCartResponseDTO = borrowedCartService.returnBook(cartId);
