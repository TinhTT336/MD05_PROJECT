...
public class WaitingRequestController {
    ...
    public ResponseEntity<?>getRequestById(@PathVariable ("requestId") Long requestId) throws CustomException {
    ...
    public ResponseEntity<?>cancelRequestById(@PathVariable ("requestId")  Long requestId) throws CustomException {
        WaitingRequestResponseDTO waitingRequestResponseDTO=waitingRequestService.cancelWaitingRequestByUser(requestId);
